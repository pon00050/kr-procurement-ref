...
근거: 국가계약법 시행령 제7조의2 (정의), 물품 다수공급자계약 업무처리규정 (계약체결 원칙).
...
| 구분 | 인원 | 근거 |
|------|------|------|
| **법령상 정의** — 다수공급자계약이 되기 위한 최소 요건 | **2인 이상** | 국가계약법 시행령 제7조의2 |
| **실무 계약체결 원칙** — 가격협상 완료 후 계약상대자 수 | **3인 이상 원칙** | 물품 다수공급자계약 업무처리규정 |

### 법령 정의 (국가계약법 시행령 제7조의2)

> 수요기관이 필요로 하는 수요물자를 구매하기 위하여 품질·성능 또는 효율 등이 같거나 비슷한 종류의 수요물자를 수요기관이 선택할 수 있도록 **2인 이상**을 계약상대자로 하여 수요물자를 단가를 정하여 체결하는 계약
